...
<div>
            ...
            <div class="co-md-5 text-center text-md-start">
                <div>
                    <div class="text-center">
                        ...
                        <div class="display-3" style="font-family: cursive; color:fuchsia">Hello, my name
                            is ${pet.nickname}!
                        </div>
    ...
    <div style="border: 2px solid #c900bf;   outline: #e8bbe6 solid 10px;  margin: auto; text-align: center; width: 80%;">
        ...
        <div class="row justify-content-around">
            <div class="col-12 col-lg-6">
                <div class="card" style="width: 100%; padding: 10px;">
                    <div class="row justify-content-center">
                        <div class="polaroid">
                            <img src="${user.avatarPath}" alt="Name">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card" style="width: 100%; border: 2px solid #eee; padding: 10px;">
                    ...
                    <div class="container text-center">
                        ...
                        <a href="/profile/${user.id}" target="_blank" class="profile-link">Check
                            Profile</a>
